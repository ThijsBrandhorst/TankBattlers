...
class PlayerTank2 extends GameEntity {
  ...
  private updateUI = () => {
    document.getElementById('player2-health')!.innerText = this._health.toString();
    document.getElementById('player2-ammo')!.innerText = this.ammo.toString();
  }
  ...
  private respawn = async () => {
    ...
    //respawn countdown
    let countdown = 5;
    const countdownElement = document.getElementById("player2-respawn")!;
    const countdownText = document.getElementById("player2-countdown")!;
